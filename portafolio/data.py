...
class Info:
    def __init__(self, icon, title, subtitle, description, date="", certificate="", technologies=[], image="", url="", github="",  githubdos=""):
        self.icon = icon
        self.title = title
...
class Data:
    def __init__(
        ...
        self.about = about
        self.technologies = [Technology(**tech) for tech in technologies]
        self.technologieslearning = [Technologylearning(**tech) for tech in technologieslearning]
